...
resource "aws_subnet" "public" {
  ...
  tags = { Name = "myapp-public-subnet-${count.index}" }
}
...
resource "aws_eks_node_group" "main" {
  ...
  node_group_name = "myapp-nodegroup"
...
resource "aws_s3_bucket" "myapp" {
  bucket = "myapp-${var.environment}-${data.aws_caller_identity.current.account_id}"
  tags = { Name = "myapp-bucket" }
}
